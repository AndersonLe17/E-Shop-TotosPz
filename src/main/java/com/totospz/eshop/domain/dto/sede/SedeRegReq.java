...
public class SedeRegReq {
    ...
    @NotNull(message = "El nombre de la sede no debe ser nulo.")
    ...
    @NotNull(message = "El ubigeo de la sede no debe ser nulo.")
    ...
    @NotNull(message = "La dirección de la sede no debe ser nulo.")
    ...
    @NotNull(message = "El RUC de la sede no debe ser nulo.")
    ...
    @NotNull(message = "La razón social de la sede no debe ser nulo.")
